...
Require Import strip_coercions tactics.misc.
...
Global Hint Extern 20 (AffirmativeEquality ?X) => let t := strip_coercions X in real_progress ltac:(fun _ => change (AffirmativeEquality t)) : typeclass_instances.
Global Hint Extern 20 (RefutativeEquality ?X) => let t := strip_coercions X in real_progress ltac:(fun _ => change (RefutativeEquality t)) : typeclass_instances.
Global Hint Extern 20 (DecidableEquality ?X) => let t := strip_coercions X in real_progress ltac:(fun _ => change (DecidableEquality t)) : typeclass_instances.
Global Hint Extern 20 (AdditiveCancellation ?X) => let t := strip_coercions X in real_progress ltac:(fun _ => change (AdditiveCancellation t)) : typeclass_instances.
Global Hint Extern 20 (IsDecEq ?X) => let t := strip_coercions X in real_progress ltac:(fun _ => change (IsDecEq t)) : typeclass_instances.
Global Hint Extern 20 (StrongSet ?X) => let t := strip_coercions X in real_progress ltac:(fun _ => change (StrongSet t)) : typeclass_instances.
...
Global Hint Extern 4 (SemiLattice ?X) => exact_strip_coercions X : typeclass_instances.
...
Global Hint Extern 4 (BoundedSemiLattice ?X) => exact_strip_coercions X : typeclass_instances.
...
Global Hint Extern 4 (MeetSemiLattice ?X) => exact_strip_coercions X : typeclass_instances.
Global Hint Extern 4 (BoundedMeetSemiLattice ?X) => exact_strip_coercions X : typeclass_instances.
Global Hint Extern 4 (JoinSemiLattice ?X) => exact_strip_coercions X : typeclass_instances.
Global Hint Extern 4 (BoundedJoinSemiLattice ?X) => exact_strip_coercions X : typeclass_instances.
Global Hint Extern 4 (Lattice ?X) => exact_strip_coercions X : typeclass_instances.
Global Hint Extern 4 (DistributiveLattice ?X) => exact_strip_coercions X : typeclass_instances.
...
Global Hint Extern 4 (AdditiveCancellation    ?X) => exact_strip_coercions X : typeclass_instances.
Global Hint Extern 4 (NonZeroMultiplicativeCancellation ?X) => exact_strip_coercions X : typeclass_instances.
...
Global Hint Extern 4 (LeftNearRng ?X) => exact_strip_coercions X : typeclass_instances.
...
Global Hint Extern 4 (LeftNearRing ?X) => exact_strip_coercions X : typeclass_instances.
...
Global Hint Extern 4 (OneNonZero           ?X) => exact_strip_coercions X : typeclass_instances.
Global Hint Extern 4 (NoZeroDivisors       ?X) => exact_strip_coercions X : typeclass_instances.
Global Hint Extern 4 (StrongNoZeroDivisors ?X) => exact_strip_coercions X : typeclass_instances.
Global Hint Extern 4 (IntegralDomain ?X) => exact_strip_coercions X : typeclass_instances.

Global Hint Extern 4 (MonUnit_Pointed_Morphism ?f) => exact_strip_coercions f : typeclass_instances.
Global Hint Extern 4 (Top_Pointed_Morphism ?f) => exact_strip_coercions f : typeclass_instances.
Global Hint Extern 4 (Bottom_Pointed_Morphism ?f) => exact_strip_coercions f : typeclass_instances.
...
Global Hint Extern 4 (MeetSemiLattice_Morphism ?f) => exact_strip_coercions f : typeclass_instances.
Global Hint Extern 4 (JoinSemiLattice_Morphism ?f) => exact_strip_coercions f : typeclass_instances.
Global Hint Extern 4 (BoundedMeetSemiLattice_Morphism ?f) => exact_strip_coercions f : typeclass_instances.
Global Hint Extern 4 (BoundedJoinSemiLattice_Morphism ?f) => exact_strip_coercions f : typeclass_instances.
Global Hint Extern 4 (Lattice_Morphism ?f) => exact_strip_coercions f : typeclass_instances.
...
Record semigroup :=
  { semigroup_car :> set
  ; #[canonical=no, reversible=no] semigroup_op :> has_sg_op semigroup_car
  ; #[canonical=no, reversible=no] semigroup_prop :> SemiGroup semigroup_car
  }.
...
; #[canonical=no, reversible=no] semigroup_morphism_prop :> SemiGroup_Morphism semigroup_morphism_fun
}.
...
Record multiplicative_semigroup :=
  ...
  ; #[canonical=no, reversible=no] multiplicative_semigroup_op :> has_mult multiplicative_semigroup_car
  ; #[canonical=no, reversible=no] multiplicative_semigroup_prop :> MultiplicativeSemiGroup multiplicative_semigroup_car
  }.
...
; #[canonical=no, reversible=no] multiplicative_semigroup_morphism_prop :> MultiplicativeSemiGroup_Morphism multiplicative_semigroup_morphism_fun
}.
...
Record commutative_semigroup :=
  ...
  ; #[canonical=no, reversible=no] commutative_semigroup_op :> has_sg_op commutative_semigroup_car
  ; #[canonical=no, reversible=no] commutative_semigroup_prop :> CommutativeSemiGroup commutative_semigroup_car
  }.
...
Record monoid :=
  { monoid_car :> set
  ; #[canonical=no, reversible=no] monoid_op :> has_sg_op monoid_car
  ; #[canonical=no, reversible=no] monoid_u  :> has_mon_unit monoid_car
  ; #[canonical=no, reversible=no] monoid_prop :> Monoid monoid_car
  }.
...
; #[canonical=no, reversible=no] monoid_morphism_prop :> Monoid_Morphism monoid_morphism_fun
}.
...
Record multiplicative_monoid :=
  ...
  ; #[canonical=no, reversible=no] multiplicative_monoid_op :> has_mult multiplicative_monoid_car
  ; #[canonical=no, reversible=no] multiplicative_monoid_u  :> has_one multiplicative_monoid_car
  ; #[canonical=no, reversible=no] multiplicative_monoid_prop :> MultiplicativeMonoid multiplicative_monoid_car
  }.
...
; #[canonical=no, reversible=no] multiplicative_monoid_morphism_prop :> MultiplicativeMonoid_Morphism multiplicative_monoid_morphism_fun
}.
...
Record strong_op_monoid :=
  ...
  ; #[canonical=no, reversible=no] strong_op_monoid_op :> has_sg_op strong_op_monoid_car
  ; #[canonical=no, reversible=no] strong_op_monoid_u  :> has_mon_unit strong_op_monoid_car
  ; #[canonical=no, reversible=no] strong_op_monoid_prop :> StrongOpMonoid strong_op_monoid_car
  }.
...
Record commutative_monoid :=
  ...
  ; #[canonical=no, reversible=no] commutative_monoid_op :> has_sg_op commutative_monoid_car
  ; #[canonical=no, reversible=no] commutative_monoid_u  :> has_mon_unit commutative_monoid_car
  ; #[canonical=no, reversible=no] commutative_monoid_prop :> CommutativeMonoid commutative_monoid_car
  }.
...
Record additive_non_com_monoid :=
  ...
  ; #[canonical=no, reversible=no] additive_non_com_monoid_op :> has_plus additive_non_com_monoid_car
  ; #[canonical=no, reversible=no] additive_non_com_monoid_u  :> has_zero additive_non_com_monoid_car
  ; #[canonical=no, reversible=no] additive_non_com_monoid_prop :> AdditiveNonComMonoid additive_non_com_monoid_car
  }.
...
; #[canonical=no, reversible=no] additive_non_com_monoid_morphism_prop :> AdditiveMonoid_Morphism additive_non_com_monoid_morphism_fun
}.
...
Record additive_monoid :=
  ...
  ; #[canonical=no, reversible=no] additive_monoid_op :> has_plus additive_monoid_car
  ; #[canonical=no, reversible=no] additive_monoid_u  :> has_zero additive_monoid_car
  ; #[canonical=no, reversible=no] additive_monoid_prop :> AdditiveMonoid additive_monoid_car
  }.
...
Record group :=
  { group_car :> set
  ; #[canonical=no, reversible=no] group_op :> has_sg_op group_car
  ; #[canonical=no, reversible=no] group_u  :> has_mon_unit group_car
  ; #[canonical=no, reversible=no] group_i  :> has_inv group_car
  ; #[canonical=no, reversible=no] group_prop :> Group group_car
  }.
...
Record ab_group :=
  { ab_group_car :> set
  ; #[canonical=no, reversible=no] ab_group_op :> has_sg_op ab_group_car
  ; #[canonical=no, reversible=no] ab_group_u  :> has_mon_unit ab_group_car
  ; #[canonical=no, reversible=no] ab_group_i  :> has_inv ab_group_car
  ; #[canonical=no, reversible=no] ab_group_prop :> AbGroup ab_group_car
  }.
...
Record additive_non_com_group :=
  ...
  ; #[canonical=no, reversible=no] additive_non_com_group_op :> has_plus additive_non_com_group_car
  ; #[canonical=no, reversible=no] additive_non_com_group_u  :> has_zero additive_non_com_group_car
  ; #[canonical=no, reversible=no] additive_non_com_group_i  :> has_negate additive_non_com_group_car
  ; #[canonical=no, reversible=no] additive_non_com_group_prop :> AdditiveNonComGroup additive_non_com_group_car
  }.
...
Record additive_group :=
  ...
  ; #[canonical=no, reversible=no] additive_group_op :> has_plus additive_group_car
  ; #[canonical=no, reversible=no] additive_group_u  :> has_zero additive_group_car
  ; #[canonical=no, reversible=no] additive_group_i  :> has_negate additive_group_car
  ; #[canonical=no, reversible=no] additive_group_prop :> AdditiveGroup additive_group_car
  }.
...
Record near_rig :=
  { near_rig_car :> set
  ; #[canonical=no, reversible=no] near_rig_p :> has_plus near_rig_car
  ; #[canonical=no, reversible=no] near_rig_z :> has_zero near_rig_car
  ; #[canonical=no, reversible=no] near_rig_m :> has_mult near_rig_car
  ; #[canonical=no, reversible=no] near_rig_o :> has_one  near_rig_car
  ; #[canonical=no, reversible=no] near_rig_prop :> NearRig near_rig_car
  }.
...
; #[canonical=no, reversible=no] near_rig_morphism_prop :> Rig_Morphism near_rig_morphism_fun
}.
...
Record rig :=
  { rig_car :> set
  ; #[canonical=no, reversible=no] rig_p :> has_plus rig_car
  ; #[canonical=no, reversible=no] rig_z :> has_zero rig_car
  ; #[canonical=no, reversible=no] rig_m :> has_mult rig_car
  ; #[canonical=no, reversible=no] rig_o :> has_one  rig_car
  ; #[canonical=no, reversible=no] rig_prop :> Rig rig_car
  }.
...
Record strong_rig :=
  { strong_rig_rig :> rig
  ; #[canonical=no, reversible=no] strong_rig_prop :> StrongSet strong_rig_rig
  }.
...
Record commutative_rig :=
  ...
  ; #[canonical=no, reversible=no] commutative_rig_p :> has_plus commutative_rig_car
  ; #[canonical=no, reversible=no] commutative_rig_z :> has_zero commutative_rig_car
  ; #[canonical=no, reversible=no] commutative_rig_m :> has_mult commutative_rig_car
  ; #[canonical=no, reversible=no] commutative_rig_o :> has_one  commutative_rig_car
  ; #[canonical=no, reversible=no] commutative_rig_prop :> CommutativeRig commutative_rig_car
  }.
...
Record near_ring :=
  { near_ring_car :> set
  ; #[canonical=no, reversible=no] near_ring_p :> has_plus   near_ring_car
  ; #[canonical=no, reversible=no] near_ring_z :> has_zero   near_ring_car
  ; #[canonical=no, reversible=no] near_ring_m :> has_mult   near_ring_car
  ; #[canonical=no, reversible=no] near_ring_o :> has_one    near_ring_car
  ; #[canonical=no, reversible=no] near_ring_n :> has_negate near_ring_car
  ; #[canonical=no, reversible=no] near_ring_prop :> NearRing near_ring_car
  }.
...
Record ring :=
  { ring_car :> set
  ; #[canonical=no, reversible=no] ring_p :> has_plus   ring_car
  ; #[canonical=no, reversible=no] ring_z :> has_zero   ring_car
  ; #[canonical=no, reversible=no] ring_m :> has_mult   ring_car
  ; #[canonical=no, reversible=no] ring_o :> has_one    ring_car
  ; #[canonical=no, reversible=no] ring_n :> has_negate ring_car
  ; #[canonical=no, reversible=no] ring_prop :> Ring ring_car
  }.
...
Record commutative_ring :=
  ...
  ; #[canonical=no, reversible=no] commutative_ring_p :> has_plus   commutative_ring_car
  ; #[canonical=no, reversible=no] commutative_ring_z :> has_zero   commutative_ring_car
  ; #[canonical=no, reversible=no] commutative_ring_m :> has_mult   commutative_ring_car
  ; #[canonical=no, reversible=no] commutative_ring_o :> has_one    commutative_ring_car
  ; #[canonical=no, reversible=no] commutative_ring_n :> has_negate commutative_ring_car
  ; #[canonical=no, reversible=no] commutative_ring_prop :> CommutativeRing commutative_ring_car
  }.
